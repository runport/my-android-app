...
fun MyApplicationTheme(
  ...
  selectedFont: PersianFont = PersianFont.YEKAN,
  ...
  val typography = remember(selectedFont, customFontFamily) {
    getTypographyWithFont(selectedFont.getFontFamily(customFontFamily))
  }
